...
export const PLATFORM_BRANDS: PlatformBrand[] = [
  {
    ...
    glyph: (
      <svg {...box} fill="currentColor">
        ...
        <path d="M6.9 17.6a2.15 2.15 0 0 0 2.72-1.15l-.9-.37a1.6 1.6 0 0 1-2.07.9L4 15.9a2.15 2.15 0 0 0 2.9 1.7z" opacity="0" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    glyph: (
      <svg {...box} fill="currentColor">
        ...
        <path d="M9.5 7h5v1.8h-3.1v1.4h2.7V12h-2.7v1.5h3.2V15H9.5z" fill="#2f2f37" />
      </svg>
    ),
  },
  {
