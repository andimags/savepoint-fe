...
import { changePassword, getMe, updateProfile, uploadAvatar, type Me } from '@/lib/api-client';
...
export function ProfileSettingsClient() {
  ...
  async function handleSaveProfile(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const updated = await updateProfile(token, { displayName, username });
      setMe(updated);
  ...
  const avatarInitials = (me.displayName || me.username).slice(0, 2).toUpperCase();
    ...
    <div className="space-y-6">
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-2">
              ...
              >
                {uploadingAvatar ? 'Uploading...' : me.avatarUrl ? 'Change picture' : 'Upload picture'}
              </Button>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your display name and username are visible to others.</CardDescription>
        </CardHeader>
        <CardContent>
